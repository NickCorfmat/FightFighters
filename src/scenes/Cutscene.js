class Cutscene extends Phaser.Scene {
    ...
    create() {
        // background
        this.redBackground = this.add.tileSprite(0, 0, 158, 106, 'fire-background').setOrigin(0).setScale(7.6)
        ...
        this.rumble = this.add.sprite(0, height/2, 'rumble_cutscene_start').setOrigin(0, 0.5).setScale(7.5).setAlpha(1)
